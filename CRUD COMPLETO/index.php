...
mysqli_report(MYSQLI_REPORT_ERROR | MYSQLI_REPORT_STRICT); // ativa exceções do MySQLi
...
if (isset($_GET['delete'])) {
    ...
    try {
        ...
        echo "<script>alert('Erro ao deletar: " . $e->getMessage() . "'); window.location.href='index.php';</script>";
        exit;
    }
...
if (isset($_POST['update'])) {
    ...
    try {
        ...
        echo "<script>
                alert('Erro ao atualizar: " . $e->getMessage() . "');
